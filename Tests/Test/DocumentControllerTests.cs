...
namespace SWKOM_DMS.Tests
{
    ...
    public class DocumentControllerTests
    {
        ...
        private Mock<IMapper> _mockMapper;
        private Mock<ILogger<DocumentsController>> _mockLogger;
        private Mock<RabbitMQService> _mockRabbitMQService; // Add a mock for RabbitMQService
        private DocumentsController _controller;
        ...
        public void SetUp()
        {
            ...
            // Setup a mock configuration for RabbitMQService
        ...
        {"RabbitMQ:QueueName", "documents_queue"}
            ...
            _mockRabbitMQService = new Mock<RabbitMQService>(configuration);
        ...
        public async Task UploadDocument_Returns_OkResult_When_Valid()
        {
            ...
            {
                FileName = "test.pdf",
                FileType = "pdf", // Add FileType to satisfy the requirement
                ContentType = "application/pdf",
                FileContent = new byte[] { 0x1, 0x2, 0x3 }
            };
